...
class OrderRepositoryTest {
    ...
    void testSaveCreate() {
        ...
        assertEquals(order.getId(), orderRepository.findById(order.getId()).getId());
        assertEquals(1, orderRepository.findAllByAuthor(order.getAuthor()).size());
    }
    ...
    void testSaveUpdate() {
        ...
        assertEquals("SUCCESS", orderRepository.findById(order.getId()).getStatus());
        assertEquals(1, orderRepository.findAllByAuthor(order.getAuthor()).size());
    }
